...
# Un conjunto solo puede tener elementos inmutables
# no listas, no conjuntos 
"""print('Ejemplo #6: {5, [3, 2, 4], 1, 0, 6}')
conjunto = {5, [3, 2, 4], 1, 0, 6}
print(conjunto, "\n")

print('Ejemplo #6b: {5, {3, 2, 4}, 1, 0, 6}')
conjunto = {5, {3, 2, 4}, 1, 0, 6}
print(conjunto, "\n") """

# Si puede tener tuplas al ser inmutable
print('Ejemplo #6c: {5, (3, 2, 4), 1, 0, 6}')
conjunto = {5, (3, 2, 4), 1, 0, 6}
print(conjunto, "\n")

print("Ejemplos con la función set(): \n")
